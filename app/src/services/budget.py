...
from app.src.schemas import FullBudgetResponse, User, BudgetRequest, BudgetCreate, ExpenseParticipantCreate, UserExpenseResponse, UserTotalExpenseResponse
...
class BudgetService:
    ...
    async def create_budget_with_participants(self, budget_request: BudgetRequest) -> FullBudgetResponse:
        ...
        for tg_id in budget_request.participants:
            ...
            participant_data = ExpenseParticipantCreate(
